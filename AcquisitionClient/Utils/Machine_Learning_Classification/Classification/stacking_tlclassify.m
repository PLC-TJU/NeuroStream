...
function [predlabel, decision_values, testacc] = stacking_tlclassify(model, testdata, testlabel)
...
if useParallel
    ...
    parfor i = 1:nSubModels
        ...
        % 使用子模型分类
        [pred, dv, ~] = p_classify(subModel, fdata, testlabel);
